{
    ...
    "definitions": {
        "node-config": {
            ...
            "properties": {
                ...
                "extras": {"type": "object", "$ref": "#/definitions/extras-config"},
                "config": {"$ref": "#/definitions/config-config"},
                "stages": {"type": "object", "$ref": "#/definitions/stages-config"},
                "dns": {"type": "object", "$ref": "#/definitions/dns-config"},
                "certificate": {
                    "type": "object",
            ...
            "allOf": [
                ...
                {
                    "if": {
                        "properties": {"kind": {"pattern": "(srl|nokia_srlinux)"}},
                        "required": ["kind"],
                    },
                    "then": {
                        "properties": {
                ...
                {
                    "if": {
                        "properties": {"kind": {"pattern": "(vr-sros|vr-nokia_sros)"}},
                        "required": ["kind"],
                    },
                    "then": {
                        "properties": {
        ...
        "certificate-authority-config": {
            ...
            "oneOf": [
                ...
                },
                {
                    ...
                    "not": {"anyOf": [{"required": ["cert"]}, {"required": ["key"]}]},
                },
            ],
        },
        "stages-config": {
            ...
            "properties": {
                "create": {
                    ...
                    "properties": {
                        "wait-for": {"$ref": "#/definitions/wait-for-config"},
                        "exec": {"$ref": "#/definitions/stage-exec"},
                    },
                    "additionalProperties": false,
                },
                "create-links": {
        ...
        "wait-for-config": {
            ...
            "items": {
                "type": "object",
                "properties": {
                    "node": {"type": "string", "description": "node name to wait for"},
                    "stage": {
                        "type": "string",
        ...
        "stages-enum": {
            "type": "string",
            "enum": ["create", "create-links", "configure", "healthy", "exit"],
        },
        "stage-exec": {
            "type": "object",
            "description": "per-stage exec configuration",
            "properties": {
                "on-enter": {"$ref": "#/definitions/stage-exec-list"},
                "on-exit": {"$ref": "#/definitions/stage-exec-list"},
            },
        },
        "stage-exec-list": {
            "type": "array",
    ...
    "type": "object",
    "properties": {
        "name": {"description": "topology name", "type": "string"},
        "prefix": {
        ...
        "topology": {
            ...
            "properties": {
                ...
                "kinds": {
                    ...
                    "type": "object",
                    "properties": {
                        "srl": {"$ref": "#/definitions/node-config"},
                        ...
                        "c8000": {"$ref": "#/definitions/node-config"},
                        "c8000v": {"$ref": "#/definitions/node-config"},
                        "cvx": {"$ref": "#/definitions/node-config"},
                ...
                "links": {
                    ...
                    "minItems": 1,
                    "items": {"$ref": "#/definitions/link-config"},
                },
            },
            "required": ["nodes"],
        },
