# Generated by Django 4.2.15 on 2024-08-18 01:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('custom_template', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='containerlab_topology', to='containerlab.topologytemplate')),
                ('dynamic_group', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='containerlab_topology', to='extras.dynamicgroup')),
